...
class CnsValidation implements Rule
{
    /**
    ...
    {
        return self::numbersStartedWithOneOrTwo($value) || self::numbersStartedWithSevenEightOrNine($value);
    }
    ...
    private static function numbersStartedWithOneOrTwo($value): bool
    {
        if (trim($value) != 15) {
            return false;
        }
    ...
    private static function numbersStartedWithSevenEightOrNine($value): bool
    {
